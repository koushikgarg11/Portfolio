      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-left mb-14">
          <div className="inline-flex items-center gap-2 text-xs font-mono tracking-widest text-cyan-400 uppercase font-semibold">
            ...
            Featured Work & Research Reports
          </div>
          <h2 className="text-3xl sm:text-4xl font-black text-white mt-2 tracking-tight">
            Data Science, Analytics & Research Projects
          </h2>
          <p className="text-slate-400 text-sm sm:text-base mt-2 max-w-2xl">
            Production-grade systems, spatial intelligence platforms, institutional benchmarking databases, pan-India workforce analytics, and demand forecasting models.
          </p>
        </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2.5 pt-3">
                    ...
                    {project.reportPdf && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-slate-900 text-cyan-300 hover:text-white border border-cyan-500/40 hover:border-cyan-400 text-xs font-semibold transition-all hover:bg-cyan-500/10"
                        title="Download Full Project PDF Report"
                      >
